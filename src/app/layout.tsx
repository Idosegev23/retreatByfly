...
export const metadata: Metadata = {
  ...
  description: "ריטריט בנושא העצמה נשית, שמשלב עומק, רוגע והנאה. 5 ימים של נשים בלבד, מרחב בטוח, מחבק ומעצים. אבו דאבי, ינואר 2026.",
  keywords: ["ריטריט", "העצמה נשית", "נשים", "אבו דאבי", "סדנאות", "חזון", "ביטחון עצמי"],
  openGraph: {
    title: "תקווה ורודה | ריטריט העצמה נשית",
    description: "5 ימים של חיבור לעצמך - סדנאות העצמה, זמן לבריכה ומנוחה, אוכל טוב וחברות אמיתית",
    locale: "he_IL",
    type: "website",
  },
};
