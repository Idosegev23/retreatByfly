...
export function ParallaxQuote() {
  ...
  // Second line (מחוברת ועוצמתית) - comes from left with zoom
  ...
  const line2Scale = useTransform(scrollYProgress, [0.1, 0.45, 0.55, 0.9], [0.7, 1, 1, 1.1]);
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 text-center">
        ...
        >
          ...
          >
            ...
            <span style={{ color: '#5a4a42' }}>את לא בורחת מהחיים – את חוזרת אליהם</span>
          </motion.div>
          
          {/* Second line - from left with zoom */}
          <motion.div
          ...
          >
            ...
            <span style={{ color: 'var(--accent)', fontSize: '0.6em' }}>&rdquo;</span>
          </motion.div>
        </blockquote>
