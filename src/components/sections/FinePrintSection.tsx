...
const sections = [
  ...
  },
  {
    ...
    icon: icons.cancel,
    items: [
      { text: "ביטול עד 14 ימים מיום ההזמנה ולפחות 7 ימי עסקים לפני מועד היציאה – החזר מלא בניכוי דמי ביטול של 5% או 100 ₪, הנמוך מביניהם" },
      { text: "ביטול לאחר 14 ימים מיום ההזמנה או פחות מ-7 ימי עסקים לפני היציאה – ייתכנו דמי ביטול בהתאם לתנאי הספקים" },
      { text: "לאחר תחילת הטיסה או החבילה – לא יינתן החזר כספי" },
      { text: "הביטול יתבצע בכתב בלבד (מייל או וואטסאפ)" },
    ],
    footer: "בהתאם לחוק הגנת הצרכן, התשמ״א-1981",
  },
];
